...
def _get_version(dist: str = "griffe-typingdoc") -> str:
...
def _get_debug_info() -> _Environment:
    ...
    packages = ["griffe-typingdoc"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("GRIFFE_TYPINGDOC")]]
    return _Environment(
